...
"""
SYNOPSIS
    Prepare the ICGC BRCA-UK donor and sample files into a clinical tsv format that is suitable for input into
...
EXAMPLES
    ```
    ./prep_icgc_brcaUK_clinical.py \
        --donor-file ./donor.BRCA-UK.tsv \
        --sample-file ./sample.BRCA-UK.tsv \
        --out-clinical ./icgc_brca_uk.clinical.r1.tsv
    ```
